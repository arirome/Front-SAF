...
import imgDasboard from './../../../Components/Assets/images/dashboard/people.svg'
             ...
             <div className="col-md-12 grid-margin">
               <div className="row">
                 <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                   ...
                   <h6 className="font-weight-normal mb-0">¡Todos los sistemas funcionan sin problemas. <span className="text-primary">Tienes 3 alertas sin leer!</span></h6>
                 </div>
                 ...
                 <div className="card-people mt-auto">
                   ...
                   <div className="weather-info">
                     <div className="d-flex">
                       ...
                       <div className="ml-2">
                         <h4 className="location font-weight-normal">Formosa</h4>
                         <h6 className="font-weight-normal">Argentina</h6>
                       </div>
                     </div>
                   </div>
                 </div>
