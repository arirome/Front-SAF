                ...
                <div className="card shadow-lg ">
                  <div className="row  mx-auto justify-content-center text-center">
                    <div className="col-12 mt-3 ">
                      ...
                      <img src={imagenVerPunto} alt="" className="itemImg" style={{width:"7vh", position:"relative", top:"-2vh"}}  />
                        PUNTO
...
<h3>NOMBRE<hr style={{background:"#045694"}}/></h3>
...
<h3>BARRIO<hr style={{background:"#045694"}}/></h3>
...
<div class="form-group mt-5">
<h3>DESCRIPCION<hr style={{background:"#045694"}}/></h3>
  ...
  <h4>📌{punto?.descripcion}</h4>
                    ...
                    <div className="col-md-5">
                      <div className="card border-0 ">
                        ...
                        <div class="form-group">
                        <h3>DEPARTAMENTO<hr style={{background:"#045694"}}/></h3>
...
<div class="form-group mt-5">
  ...
  <h3>ULTIMA ACTUALIZACIÓN  <hr style={{background:"#045694"}}/></h3>
